...
(function () {
  ...
  var RV_CSS = [
    ".rv-overlay{position:fixed;inset:0;z-index:9995;background:var(--ink);display:none;}",
    ".rv-overlay.open{display:flex;}",
    ".rv-panel{flex:1;min-height:0;width:100%;max-width:1200px;margin:0 auto;display:flex;flex-direction:column;background:var(--panel);border:1px solid var(--line);}",
    "@media(min-width:700px){.rv-panel{border-radius:4px;overflow:hidden;}}",
    ".rv-bar{display:flex;align-items:center;gap:14px;padding:12px 16px;border-bottom:1px solid var(--line);flex:none;flex-wrap:wrap;background:var(--panel);}",
    ...
    ".rv-tabs{display:flex;gap:2px;flex:1;flex-wrap:wrap;background:var(--ink);border:1px solid var(--line);border-radius:4px;padding:3px;min-width:200px;}",
    ...
    ".rv-close{font-family:\"Space Grotesk\",system-ui,sans-serif;font-size:12px;font-weight:600;letter-spacing:.1em;min-height:44px;padding:10px 18px;border-radius:4px;border:1px solid var(--line);background:transparent;color:var(--paper);cursor:pointer;}",
    ...
    ".rv-tsep{width:1px;height:28px;background:var(--line);margin:0 4px;}",
    ".rv-btn{font-family:\"Space Grotesk\",system-ui,sans-serif;font-size:12px;font-weight:600;letter-spacing:.1em;min-height:48px;padding:12px 20px;border-radius:4px;border:1px solid var(--line);background:transparent;color:var(--steel);cursor:pointer;}",
    ".rv-btn:hover{border-color:var(--line);color:var(--paper);}",
    ".rv-btn:active{transform:scale(.97);}",
    ".rv-btn:focus-visible{outline:2px solid var(--ember);outline-offset:2px;}",
    ".rv-btn.pri{background:var(--ember);border-color:var(--ember);color:var(--ink);}",
    ".rv-btn.pri:hover{background:var(--ember);border-color:var(--ember);color:var(--ink);}",
    ...
    ".rv-edwrap{display:flex;background:var(--ink);border:1px solid var(--line);border-radius:4px;overflow:hidden;}",
    ".rv-edwrap:focus-within{border-color:rgba(140,63,34,.55);box-shadow:0 0 0 2px rgba(140,63,34,.18);}",
    ".rv-gutter{flex:none;width:48px;padding:14px 10px 14px 0;text-align:right;font-family:\"IBM Plex Mono\",monospace;font-size:13px;line-height:1.7;color:var(--steel);border-right:1px solid var(--line);overflow:hidden;user-select:none;background:var(--panel);white-space:pre;}",
    ...
    ".rv-pane{border:1px solid var(--line);border-radius:4px;background:var(--panel);overflow:hidden;}",
    ".rv-pane h4{margin:0;padding:12px 16px;font-family:\"Space Grotesk\",system-ui,sans-serif;font-size:11px;letter-spacing:.18em;color:var(--steel);border-bottom:1px solid var(--line);font-weight:600;}",
    ".rv-regs{display:grid;grid-template-columns:repeat(2,1fr);gap:1px;background:var(--line);max-height:336px;overflow-y:auto;}",
    ...
    ".rv-reg.chg{background:rgba(138,90,24,.06);}",
    ...
    ".rv-mc .mrow{display:flex;gap:12px;padding:6px 16px;border-bottom:1px solid var(--line);}",
    ...
    ".rv-mc .mrow.cur{background:rgba(140,63,34,.1);}",
    ...
    ".rv-card{border:1px solid var(--line);border-radius:4px;padding:18px;background:var(--panel);}",
    ...
    ".rv-mini{font-family:\"Space Grotesk\",system-ui,sans-serif;font-size:11.5px;font-weight:600;letter-spacing:.08em;min-height:44px;padding:10px 16px;border-radius:4px;border:1px solid var(--line);background:transparent;color:var(--steel);cursor:pointer;}",
    ".rv-mini:hover{border-color:var(--line);color:var(--paper);}",
    ".rv-mini.go{background:var(--ember);border-color:var(--ember);color:var(--ink);}",
    ".rv-mini.go:hover{background:var(--ember);border-color:var(--ember);color:var(--ink);}.rv-mini:focus-visible{outline:2px solid var(--ember);outline-offset:2px;}",
    ...
    ".rv-isa td{padding:9px 12px;border-bottom:1px solid var(--line);vertical-align:top;line-height:1.6;}",
    ".rv-isa td:first-child{color:var(--amber);white-space:nowrap;}",
    ".rv-isa td:last-child{color:var(--steel);}",
    ".rv-win{border:1px solid rgba(47,107,68,.4);background:rgba(47,107,68,.06);border-radius:4px;padding:16px 18px;margin-bottom:14px;font-family:\"Space Grotesk\",system-ui,sans-serif;color:var(--mint);font-size:13.5px;letter-spacing:.02em;line-height:1.65;}",
    ".rv-lesson-banner{border:1px solid var(--line);background:var(--panel);border-radius:4px;padding:14px 16px;margin-bottom:14px;font-size:13.5px;color:var(--steel);line-height:1.65;font-family:\"Space Grotesk\",system-ui,sans-serif;}",
